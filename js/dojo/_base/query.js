...
return _82.getAttribute(_83,2)||_80;
};
...
var _fd=_f9.split(/\s*,\s*/);
var tf=function(_ff){
var _100=0;
var ret=[];
var tp;
while((tp=_fd[_100++])){
ret=ret.concat(_f4(tp,tp.indexOf(" "))(_ff));
}
return ret;
};
return _e8[_f9]=tf;
...
if(d.isIE&&_3){
var _107=_103+"";
arr[0].setAttribute("_zipIdx",_107);
for(var x=1,te;te=arr[x];x++){
if(arr[x].getAttribute("_zipIdx")!=_107){
ret.push(te);
}
te.setAttribute("_zipIdx",_107);
}
}else{
arr[0]["_zipIdx"]=_103;
for(var x=1,te;te=arr[x];x++){
if(arr[x]["_zipIdx"]!=_103){
ret.push(te);
}
te["_zipIdx"]=_103;
}
...
d.query=function(_10a,root){
if(_10a.constructor==d.NodeList){
return _10a;
}
if(!d.isString(_10a)){
return new d.NodeList(_10a);
}
if(d.isString(root)){
root=d.byId(root);
}
...
return _zip(_f8(_10a)(root));
};
d.query.pseudos=_9d;
d._filterQueryResult=function(_10d,_10e){
var tnl=new d.NodeList();
var ff=(_10e)?_64(_4(_10e)[0]):function(){
return true;
};
for(var x=0,te;te=_10d[x];x++){
if(ff(te)){
tnl.push(te);
}
}
