if(!dojo._hasResource["dojox.data.tests.stores.ServiceStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.data.tests.stores.ServiceStore"] = true;
