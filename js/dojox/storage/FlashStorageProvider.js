...
var _f=_9.join("");
var _10=_d.join(",");
dojox.flash.comm.putMultiple(_c,_f,_10,this.namespace);
...
var _16=_14.join(",");
var _17=dojox.flash.comm.getMultiple(_16,this.namespace);
var _18=eval("("+_17+")");
...
var _23=_21.join(",");
dojox.flash.comm.removeMultiple(_23,this.namespace);
