...
dijit.Editor.prototype.query=function(_5,_6,_7){
var ar=dojo.withGlobal(this.window,"query",dojo,[_5,_6]);
return (_7)?ar:ar[0];
};
dojo.declare("dojox.editor.plugins.GlobalTableHandler",dijit._editor._Plugin,{tablesConnected:false,currentlyAvailable:false,alwaysAvailable:false,availableCurrentlySet:false,initialized:false,tableData:null,shiftKeyDown:false,editorDomNode:null,undoEnabled:dojo.isIE,initialize:function(_9){
if(this.initialized){
return;
}
...
var _6a=this.selectRow.getValue()||1,_6b=this.selectCol.getValue()||1,_6c=this.selectWidth.getValue(),_6d=this.selectWidthType.getValue(),_6e=this.selectBorder.getValue(),pad=this.selectPad.getValue(),_70=this.selectSpace.getValue(),_id="tbl_"+(new Date().getTime()),t="<table id=\""+_id+"\"width=\""+_6c+((_6d=="percent")?"%":"")+"\" border=\""+_6e+"\" cellspacing=\""+_70+"\" cellpadding=\""+pad+"\">\n";
for(var r=0;r<_6a;r++){
t+="\t<tr>\n";
for(var c=0;c<_6b;c++){
