...
},acceptType:"x-application/rest+json,application/http;q=0.9,*/*;q=0.7",subscriptions:{},subCallbacks:{},autoReconnectTime:30000,sendAsJson:false,url:"/channels",autoSubscribeRoot:"/",open:function(){
if(!this.connected){
...
try{
_2f.data=_2f.content||dojo.fromJson(_2f.responseText);
}
catch(e){
}
var _30=this;
...
if(dojox.io.httpParse&&_34.match(/application\/http/)){
var _37="";
