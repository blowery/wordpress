...
return {url:_e+(dojo.isObject(id)?"?"+dojo.objectToQuery(id):id==null?"":id),handleAs:_f?"json":"text",contentType:_f?"application/json":"text/plain",sync:dojox.rpc._sync,headers:{Range:_17&&(_17.start>=0||_17.count>=0)?"items="+(_17.start||"")+"-"+((_17.count&&(_17.count+(_17.start||0)-1))||""):undefined}};
};
