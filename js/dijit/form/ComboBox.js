...
dojo.requireLocalization("dijit.form","ComboBox",null,"nb,da,pt-pt,tr,el,sv,ru,es,ROOT,pl,fi,ja,zh,ko,hu,nl,de,he,zh-tw,ar,pt,fr,cs,it");
...
if(_8.altKey||(_8.ctrlKey&&(_9!="v"&&_9!="x"))||_8.keyCode==dojo.keys.SHIFT){
return;
}
var _a=false;
...
if((_47.start+_47.length)>(_47._maxOptions-1)){
...
dojo.declare("dijit.form._ComboBoxDataStore",null,{constructor:function(_60){
this.root=_60;
dojo.query("> option",_60).forEach(function(_61){
_61.innerHTML=dojo.trim(_61.innerHTML);
});
},getValue:function(_62,_63,_64){
return (_63=="value")?_62.value:(_62.innerText||_62.textContent||"");
},isItemLoaded:function(_65){
return true;
...
var _69=dojo.data.util.filter.patternToRegExp(_66.query.name,_66.queryOptions.ignoreCase),_6a=dojo.query("> option",this.root).filter(function(_6b){
return (_6b.innerText||_6b.textContent||"").match(_69);
});
if(_66.sort){
_6a.sort(dojo.data.util.sorter.createSortFunction(_66.sort,this));
}
_67(_6a,_66);
},close:function(_6c){
return;
},getLabel:function(_6d){
return _6d.innerHTML;
},getIdentity:function(_6e){
return dojo.attr(_6e,"value");
},fetchItemByIdentity:function(_6f){
var _70=dojo.query("option[value='"+_6f.identity+"']",this.root)[0];
_6f.onItem(_70);
},fetchSelectedItem:function(){
var _71=this.root,si=_71.selectedIndex;
return dojo.query("> option:nth-child("+(si!=-1?si+1:1)+")",_71)[0];
}});
