...
dojo.requireLocalization("dijit._editor","FontChoice",null,"nb,da,pt-pt,tr,el,sv,ru,es,ROOT,pl,fi,ja,zh,ko,hu,nl,de,he,zh-tw,ar,pt,fr,cs,it");
...
this.updating=true;
this.button.setValue(dojo.indexOf(this._availableValues,_b)<0?"":_b);
