...
this.attr("disabled",_26);
},_setDisabledAttr:function(_27){
this.disabled=_27;
dojo[_27?"addClass":"removeClass"](this.domNode,"dijitMenuItemDisabled");
dijit.setWaiState(this.focusNode,"disabled",_27?"true":"false");
}});
dojo.declare("dijit.PopupMenuItem",dijit.MenuItem,{_fillContent:function(){
if(this.srcNodeRef){
var _28=dojo.query("*",this.srcNodeRef);
dijit.PopupMenuItem.superclass._fillContent.call(this,_28[0]);
...
this.inherited(arguments);
if(!this.popup){
var _29=dojo.query("[widgetId]",this.dropDownContainer)[0];
this.popup=dijit.byNode(_29);
}
